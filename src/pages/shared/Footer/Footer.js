                              ...
                              <div className="w-full -mx-6 lg:w-2/5">
                                   <div className="px-6">
                                        <div>
                                             ...
                                             <Link to='/'  className="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">i-sports photography</Link>
                                        </div>

                                        <p className="max-w-sm mt-2 text-gray-500 dark:text-gray-400">Here is out 31,000+ photo and never miss out our every photo and tips and more.</p>
